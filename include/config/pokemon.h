...
#define P_MANUAL_EVOLUTION_ONLY      TRUE       // If TRUE, Pokémon never evolve automatically from leveling up (in or out of battle). They must be evolved manually via the EVOLVE option in the party menu instead. Trade, item-use, and script-triggered evolutions are unaffected.
